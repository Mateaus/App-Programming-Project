package Controllers.LoginAndRegister_Controllers;
...
public class LoginController implements Initializable {
    ...
    public void changeToMainScreen(ActionEvent event) throws Exception {
        ...
        Pane main = (Pane) FXMLLoader.load(getClass().getResource("/resources/layout/Login_Register_Layouts/login_layout.fxml"));
    ...
    public void changeToRegisterScreen(ActionEvent event) throws Exception {
        ...
        Pane registration = (Pane) FXMLLoader.load(getClass().getResource("/resources/layout/Login_Register_Layouts/registration_layout.fxml"));
